...
@section('content')
  <pagina-v tamanho="12">
    ...
    <painel-v titulo="Lista de Autores">
  ...
  <modal-v nome="adicionar" titulo="Adicionar">
    <formulario-v id="formAdicionar" css="" action="{{route('autores.store')}}" method="post" enctype="" token="{{ csrf_token() }}">
  ...
  <modal-v nome="editar" titulo="Editar">
    <formulario-v id="formEditar" v-bind:action="'/admin/autores/' + $store.state.item.id" method="put" enctype="" token="{{ csrf_token() }}">
